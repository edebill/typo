...
I've added basic support for a configuration YAML file (Rails.root/config/ckeditor.yml). It's very simple right now. This file is not entirely needed yet, but if
